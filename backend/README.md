...
## Project Structure
    ...
    ├── fireground_rehab_29512  # Django project configurations
...
1. Clone this repo and `cd fireground_rehab_29512`
...
2. Clone this repo and `cd fireground_rehab_29512`
